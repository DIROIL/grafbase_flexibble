        ...
        <footer className="flexStart footer">
            <div className="flex flex-col gap-12 w-full">
                <div className="flex items-start flex-col">
                    ...
                    <p className="flex flex-wrap gap-12"> flexibble is
                        the world's leading community
                        for creatives to share
                        , grow, and get hired.
                    </p>
                </div>
                ...
                <div className="flex flex-wrap gap-12">
                    ...
                    <div className="flex flex-col gap-4 w-full" ><FooterColumn title={footerLinks[6].title}
                        links={footerLinks[6].
                            links} /></div>

                </div>
                <div className="flexBetween footer_copyright">
                    <p>@ 2023 flexibble footer_copyright. All rights diserved</p>
